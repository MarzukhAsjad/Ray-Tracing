...
class camera {
    ...
    private:
        ...
        //  Responsible for creating a colour object output from an input ray object
        color ray_color(const ray& r, int depth, const hittable& world) { // Depth added to control recursion
            hit_record rec;
